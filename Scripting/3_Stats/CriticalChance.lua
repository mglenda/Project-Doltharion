do
    ...
    function cc:get(u)
        return (GetHeroAgi(u, false) + (Data:get_unit_data(GetUnitTypeId(u)).crit or 0)) + BlzGetAbilityIntegerLevelField(BlzGetUnitAbility(u, cc_ability), ABILITY_ILF_AGILITY_BONUS, 0)
    end

    function cc:get_default(u)
        return (GetHeroAgi(u, false) + (Data:get_unit_data(GetUnitTypeId(u)).crit or 0))
    end
end